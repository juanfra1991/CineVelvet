...
INSERT INTO pelicula (titulo, descripcion, duracion, fecha_estreno, genero, edades, portada, publicada) VALUES
('Matrix', 'Un hacker descubre una realidad alternativa.', 136, '1997-12-19', 'Ciencia Ficción', 'No recomendada para menores de 16 años', 'matrix.jpg', TRUE),
('Titanic', 'Historia de amor a bordo de un transatlántico.', 195, '1997-12-19', 'Romance', 'Apta para todos los públicos', 'titanic.jpg', TRUE),
('El Rey León', 'El viaje de Simba hacia su destino como rey.', 88, '1994-06-24', 'Animación', 'Apta para todos los públicos', 'rey_leon.jpg', TRUE),
('Avatar', 'Una aventura en el mundo de Pandora.', 162, '2009-12-18', 'Fantasía', 'No recomendada para menores de 12 años', 'avatar.jpg', TRUE),
('Parásitos', 'Una crítica social en forma de thriller.', 132, '2019-05-30', 'Drama', 'No recomendada para menores de 16 años', 'parasitos.jpg', TRUE),
('Interstellar', 'Viaje interestelar para salvar la humanidad.', 169, '2014-11-07', 'Ciencia Ficción', 'No recomendada para menores de 12 años', 'interstellar.jpg', TRUE);
...
INSERT INTO butaca (fila, butaca, sala_id, bloqueada_hasta)
SELECT f, c, 1, NULL
